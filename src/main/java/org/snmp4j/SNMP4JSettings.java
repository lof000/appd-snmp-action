...
public final class SNMP4JSettings {
   ...
   * {@link org.snmp4j.TransportMapping} and in each {@link org.snmp4j.Snmp} session object. To ensure
   ...
   * {@link OID}s to/from a textual representation.
   *
   * @since 1.10
   */
   ...
   * {@link VariableBinding}s to/from a textual representation.
   *
   * @since 1.10
   */
